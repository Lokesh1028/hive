...
const About = () => {
  ...
  return (
    <div id="about" className="relative py-24 bg-black overflow-hidden">
      <StarsBackground />
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h2 className="font-anton text-4xl font-extrabold text-white sm:text-5xl" ref={headingRef}>
            <HyperText>why hack to the hive?</HyperText>
          </h2>
          <p className="mt-4 max-w-4xl mx-auto text-lg text-white/80 font-poppins text-left sm:text-justify" ref={descriptionRef}>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 mt-8" ref={projectsRef}>
